...
namespace TelnetEngine
{
    ...
    public class VirtualScreen : IDisposable
    {
        ...
        //public int visibleAreaY0top = 0;
        public int visibleAreaY0bottom = 0;
...
//this.changedScreen = true;
                ...
                // delete the rest
                this.CleanScreen(this.offsetx, ly - lines + 1, lx + this.offsetx, ly - 1 + this.offsety);
            }
            this.changedScreen = true;
            return lines;
        }
        ...
        void CheckYScroll()
        {
            //      if ((CursorY0 >= visibleAreaY0top))        
            if ((CursorY0 /*- visibleAreaY0top*/) > this.Height - 1)
 
                {
                    int sUp = (CursorY0 /*- visibleAreaY0top*/) - this.Height + 1;
                    this.ScrollUp(sUp);
                    //this.visibleAreaY0bottom += sUp;
                    //this.visibleAreaY0top = visibleAreaY0bottom - (Height - 1); 


                CursorY0 = this.Height - 1;
            }
        }
        ...
        public string Hardcopy(bool lowercase)
        {
            ...
            // Check the cache and the status of screen changes
        ...
        public string FindRegExOnScreenValue(string regExp, bool caseSensitive)
        {
            if (this.vs == null || regExp == null || regExp.Length < 1)
                return null;
            Regex r = caseSensitive ? new Regex(regExp) : new Regex(regExp, RegexOptions.IgnoreCase);
